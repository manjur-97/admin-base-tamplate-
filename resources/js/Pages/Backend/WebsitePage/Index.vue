...
<script setup>
    ...
    const applyFilter = () => {
        router.get(route('backend.websitepage.index'), filters.value, { preserveState: true });
    };
        ...
        <BackendLayout>
            ...
            <div class="col-xl-12">
                ...
                <div class="card-header flex-wrap border-0">
                    ...
                    <Link
                    :href="route('backend.websitepage.create')"
                    type="button"
                        ...
                        >
                            ...
                            <div class="col-sm-8 col-md-6">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    ...
                                    type="text"
                                    placeholder="Search by websitepage name"
                                    @input="applyFilter"
                                    />
                                </div>
                                </div>
