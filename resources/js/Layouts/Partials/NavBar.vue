...
const userName = user.name ||user.first_name || user.name_en||'Guest';
const userPhoto = user.photo || user.image||"/profile-icon-9.png";
...
const logout = () => {
  try {
    router.get(route("backend.auth.logout"));
  } catch (error) {
...
const employee_logout = () => {
  try {
    router.get(route("backend.employee.employee_logout"));
  } catch (error) {
    console.error("Error logging out:", error);
  }
};
...
const YashAdmin = () => {
  ...
  const sidebarFix = () => {
    $("ul#menu>li").on("click", function () {
      let sidebarStyle = $("body").attr("data-sidebar-style");
  ...
  return {
    ...
    resize: () => {
      adjustContentBody();
      setTimeout(() => adjustContentBody(), 300);
    },
    handleMenuPosition: () => {
      adjustContentBody();
    },
  ...
  <div class="nav-header">
    <a href="" class="brand-logo">
      <span class="logo-abbr">
        <img src="/images/logo.png" alt="" srcset="" height="60px">
      </span>
      ...
      <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="header-left">
            <div class="dashboard_bar">Website Builder</div>
          </div>
                ...
                <div class="dropdown header-profile2">
                  ...
                  >
                    <div class="header-info2 d-flex align-items-center">
                      <div class="header-media">
                        <img :src="userPhoto" alt="" width="80%" />
                      </div>
                    </div>
                  </a>
                  <div class="dropdown-menu dropdown-menu-end">
                    <div class="card border-0 mb-0">
                      ...
                      <div v-if=props.auth.admin class="card-body px-0 py-2">
                        <Link
                      ...
                      <div class="card-footer px-0 py-2">
                        ...
                        <a v-if=props.auth.employee
                          href="#"
                          class="dropdown-item ai-icon"
                          @click.prevent="employee_logout"
                        >
                          <svg
                            class="logout-svg"
                            xmlns="http://www.w3.org/2000/svg"
