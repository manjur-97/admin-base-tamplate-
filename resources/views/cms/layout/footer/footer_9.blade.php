    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="col-span-1 md:col-span-2">
                <h2 class="text-3xl font-bold mb-4">Your Brand</h2>
                <p class="text-gray-400 mb-6">Creating amazing experiences for our customers. We are dedicated to providing the best service.</p>
        ...
        <div class="pt-8 border-t border-gray-800">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 mb-4 md:mb-0">&copy; 2024 Your Company. All rights reserved.</p>
